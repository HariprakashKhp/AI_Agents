...
# print(split_profile_data(extract_linkedin_profile("", "", True)))

def create_vector_db(nodes: List) -> Optional[VectorStoreIndex]:
...
# print(create_vector_db(split_profile_data(extract_linkedin_profile("", "", True))))
...
# print(verify_embeddings(create_vector_db(split_profile_data(extract_linkedin_profile("", "", True)))))